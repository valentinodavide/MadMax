...
public class ProposedExpenseCommentsFragment extends Fragment implements ExpenseCommentsViewAdapter.ListItemClickListener {
    ...
    public ProposedExpenseCommentsFragment() {
